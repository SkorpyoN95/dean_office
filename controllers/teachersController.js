...
exports.teacher_list = function(req, res, next){
    ...
    .exec(function(err, docs){
        ...
        res.render('listing', {title: 'Teachers', user: req.user, group: 'teachers', collection: docs});
    });
};
...
exports.teacher_details = function(req, res, next){
    async.parallel({
       teacher: function(callback){
        ...
        res.render('profile', {title: 'Teacher profile', user: req.user, person: results.teacher,
